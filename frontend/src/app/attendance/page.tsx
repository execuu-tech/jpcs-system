...
export default function AttendancePage() {
  ...
  const handleAddEvent = async () => {
    ...
    if (
      !formData.has_morning &&
      !formData.has_afternoon &&
      !formData.has_night
    ) {
    ...
    <main className="flex flex-col min-h-screen">
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {currentEvent?.has_morning && (
                  <Button
                    variant={
                      selectedSection === "morning" ? "default" : "outline"
                    }
                ...
                {currentEvent?.has_night && (
                  <Button
                    variant={
                      selectedSection === "night" ? "default" : "outline"
                    }
                  ...
                  {filteredAttendees.map((a) => (
                    ...
                    >
                      ...
                      <p className="text-gray-600">
                        {a.member?.program} • {a.member?.yearLevel}
                        {a.member?.block}
                      </p>
      ...
      <Dialog open={isSectionModalOpen} onOpenChange={setIsSectionModalOpen}>
        <DialogContent>
          ...
          <div className="flex gap-4 mt-4 justify-center">
            {tempScanEvent?.has_morning && (
              <Button onClick={() => startScan("morning")}>Morning</Button>
            )}
            {tempScanEvent?.has_afternoon && (
              <Button onClick={() => startScan("afternoon")}>Afternoon</Button>
            )}
            {tempScanEvent?.has_night && (
              <Button onClick={() => startScan("night")}>Night</Button>
            )}
          </div>
        </DialogContent>
      </Dialog>
            ...
            <div className="flex gap-4 mt-2">
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, has_morning: e.target.checked })
                  }
                />
                Morning
              </label>
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      has_afternoon: e.target.checked,
                    })
                  }
                />
                Afternoon
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, has_night: e.target.checked })
                  }
                />
                Night
              </label>
      ...
      <Dialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
        <DialogContent>
          ...
          <p>
            Are you sure you want to delete <b>{deletingEvent?.name}</b>?
          </p>
          <DialogFooter>
            <Button
